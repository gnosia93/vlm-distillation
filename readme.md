...
마지막으로, 같은 "대형 모델 → 경량 적응" 관점을 세그멘테이션 영역으로 확장해, SAM-3 기반 영상 객체 탐지·추적의 평가와 파인튜닝도 다룹니다.
...
* `1`. K8s Job 기반 학습 데이터 병렬 생성
  ...
  - [배치 영상 샘플링 (CPU)](https://github.com/gnosia93/vlm-distillation/blob/main/sampling/2-batch-sampling.md) 
  - [배치 인퍼런스 (GPU)](https://github.com/gnosia93/vlm-distillation/blob/main/sampling/3-batch-infer.md)
...
* `3`. [객체 탐지 / 세그먼테이션 데이터 준비 (COCO)](https://github.com/gnosia93/vlm-distillation/blob/main/sam/2-coco.md)
* `4`. [파인튜닝 전략](https://github.com/gnosia93/vlm-distillation/blob/main/sam/3-finetune-strategy.md)
