...
* `2'. [배치 인퍼런스](https://github.com/gnosia93/vlm-distillation/blob/main/sampling/3-batch-infer.md)
      
* `3`. Kubeflow로 MNIST 분산학습
...
* `4`. [SOCI로 대형 컨테이너 이미지 기동 시간 최적화 (EKS)](https://github.com/gnosia93/vlm-distillation/blob/main/kubeflow/3-soci-optim-container-coldstart.md) 
