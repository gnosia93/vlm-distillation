...
| g5 | NVIDIA A10G | Ampere | 24GB | Flash Attention 2 |  |
...
G6 instances feature up to 8 NVIDIA L4 Tensor Core GPUs with 24 GB of memory per GPU and fractionalized GPU sizes with as little as 1/8 of an L4 GPU with 3 GB of GPU memory. They also support up to 192 vCPUs, up to 100 Gbps of network bandwidth, and up to 7.52 TB of local NVMe SSD storage.  |
