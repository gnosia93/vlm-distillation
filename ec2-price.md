...
| g5 | NVIDIA A10G | Ampere | 24GB | GDDR6 600 GB/s | Flash Attention 2 | * G4dn 대비 기계 학습 추론에서 최대 3배 더 높은 성능을 제공 * 최대 100Gbps의 네트워크 대역폭 및 최대 7.6TB의 로컬 NVMe SSD 스토리지를 지원  |
