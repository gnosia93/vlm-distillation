...
| P5e / P5en | 텐서코어 4세대 - [NVIDIA H200](https://www.nvidia.com/ko-kr/data-center/h200/) | Hopper | 141GB | FP32-67, FP16-1.9P FP8-3.9P  | HBM3 4.8 TB/s | NVLink 900GB/s, EFA 3.2Tbps  | P4 대비 최대 4배 연산성능, **100B+ 모델훈련**, **+ Flash Attention 3**  |
...
| P6-B300 | 텐서코어 5세대 - [NVIDIA BW B300](https://www.nvidia.com/ko-kr/data-center/hgx/) | Blackwell | 268GB | FP32-600, FP16-36P FP8-72P, FP4-144P  | HBM3e 7.7 TB/s | NVLink 1.8 TB/s, EFA 6.4Tbps | P5en 인스턴스에 비해 최대 2.25배 높은 연산성능, **+ Flash Attention 4**   |
